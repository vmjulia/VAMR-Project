...
% divide by the last row element-wise to recover u, v image/pixel coordinates
projected_points = projected_points  ./ projected_points (3,:); % [3x54] and last row is only 1, 1, 1...
