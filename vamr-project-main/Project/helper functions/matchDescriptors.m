...
sorted_dists = sorted_dists(sorted_dists~=0); % not equal
...
[~,unique_match_idxs,~] = unique(matches, 'stable'); % returns the rows of ~ in the same order as appeared in matches
