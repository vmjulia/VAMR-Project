...
params.MaxBidirectionalError = .5; % Recommended values are between 0 and 3 pixels. Forward-backward error threshold.
...
params.cont_FilterSize = 9; % an odd integer value in the range [3, min(size(I))].
...
params.cont_maxTriangulationErrorFinal = .1; % reprojection error a point can have before it is discarded
